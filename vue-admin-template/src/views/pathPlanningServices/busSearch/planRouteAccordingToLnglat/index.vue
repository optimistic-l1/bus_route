  ...
  export default {
    ...
    methods: {
      initAMap() {
        ...
        //根据起、终点坐标查询公交换乘路线
        transfer.search(new AMap.LngLat(this.origin,this.origin1), new AMap.LngLat(this.destination,this.destination1), function (status, result) {
